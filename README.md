# [oddlord](https://github.com/oddlord)’s dotfiles
...
| OS | Snippet |
|:---|:---|
| `Ubuntu` | `bash -c "$(wget -qO - https://raw.github.com/oddlord/dotfiles/master/src/os/setup.sh)"` |
